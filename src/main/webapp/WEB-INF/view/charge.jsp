...
<script src="${APP_PATH}/statics/js/jquery.min.js"></script>
    <link rel="stylesheet" href="${APP_PATH}/statics/css/flexslider.css" type="text/css" media="screen" property="" />
<!-- Custom Theme files -->
<!--theme-style-->
...
<link href='#css?family=PT+Sans:400,700' rel='stylesheet' type='text/css'>
    ...
    <link href="${APP_PATH}/statics/css/popup-box.css" rel="stylesheet" type="text/css" media="all" />
<!--//fonts-->
	<!--轮播图-->
	<title>轮播图</title>
	<meta charset="utf-8">
...
<!--content-->
                    ...
                    <div class="gallery-grids">
                        <div class="gallery-grid">
                            <a class="book popup-with-zoom-anim button-isi zoomIn animated" data-wow-delay=".5s" href="#small-dialog">
                                <img src="${APP_PATH}/statics/images/blog/sin1.jpg" alt=" " class="img-responsive zoom-img" />
                            </a>
    ...
    $(function(){
        ...
        $("#review-XIAN").popover({
            ...
            content : '<div id="popOverBox"><video src="${APP_PATH}/statics/video/microtrailer.mp4" onmouseover="videoPlayback()" onmouseout="videoStopped()" width="251" height="201" /></div>',
            animation: false
